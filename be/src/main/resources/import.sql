...
INSERT INTO question(title, content, name, faculty_id, topic_id, advisor_id, answer, approved_by_dean, created_date) VALUES ('Hỏi xếp lớp chuyên ngành cho học kỳ 2', 'Chào thầy. Mong thầy tư vấn về quy trình đăng ký và phân loại về thứ tự ưu tiên chuyên ngành cho sinh viên ở năm ba ạ. Em cảm ơn', 'Phạm Xuân Nhuận', 1, 5, 8, 'Khoảng giữa học kỳ, khoa sẽ tổ chức buổi gặp gỡ SV để tư vấn chọn chuyện ngành. Mỗi bạn sẽ đăng ký nguyện vọng chọn chuyên ngành theo thứ tự ưu tiên 1,2,3. Tinh thần là sẽ khoa sẽ sắp xếp các bạn vô chuyên ngành theo đúng nguyện vọng. Tuy nhiên, thỉnh thoảng có trường hợp các bạn tập trung vào đăng ký ngành này quá nhiều, trong khi ngành kia thì rất ít bạn chọn. Khi đó khoa sẽ dựa vào kết quả học tập của các bạn để xét và sắp xếp lại theo thứ tự ưu tiên.', 1, CURRENT_TIMESTAMP);
INSERT INTO question(title, content, name, faculty_id, topic_id, advisor_id, answer, approved_by_dean, created_date) VALUES ('Chuyển số tín chỉ cho môn Kĩ thuật lập trình', 'Môn kĩ thuật lập trình của khóa 17 là 4 chỉ, nhưng lúc em học lại là 3 chỉ. Giờ em phải lên phòng đào tạo để tiến hành chuyển 3 thành 4 hay nao khoa sẽ tự chuyển cho em ạ ?', 'Ngô Minh Thu', 1, 5, 9, 'Chào em. Em làm đơn xin thay thế môn học từ 4 chỉ xuống 3 chỉ và nộp về văn phòng Khoa để BCN Khoa xem xét nhé. Thân.', 0, CURRENT_TIMESTAMP);
